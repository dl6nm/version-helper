...
def mock_subprocess(monkeypatch, subprocess_exec_path_parameters) -> CompletedProcess:
    """Mock a command line call (subprocess)"""
    def fake_subprocess(*args, **kwargs):
        return subprocess_exec_path_parameters.get("process")
...
def subprocess_exec_path_parameters(request):
